...
<div class="blogCatAndDate"><?php echo $this->item->category_title; ?> | <?php echo date("d.m.Y", strtotime($this->item->created)); ?></div>
...
<div class="blogCategoryItemFooter row">
	<div class="blogHits col-md-6 col-sm-6 col-xs-7"><?php echo $this->item->hits; ?></div>
