...
class RLTags
{
	...
	public static function getDivTags($start_tag = '', $end_tag = '', $tag_start = '{', $tag_end = '}')
	{
		...
		$attribs = trim(preg_replace('#' . $tag_start . 'div(.*)' . $tag_end . '#si', '\1', $start_div['tag']));
	...
	public static function getDivAttributes($string)
	{
		if (strpos($string, '="') !== false)
		{
			return self::getValuesFromString($string);
		}
