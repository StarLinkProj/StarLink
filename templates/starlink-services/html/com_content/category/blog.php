...
?>
<!-- the div below is generated by com_content/category/blog template override -->
	...
	<?php if (!empty($this->intro_items)) : ?>
		<?php foreach ($this->intro_items as $key => &$item) : ?>
			...
			<?php if ($rowcount == 1) : ?>
				...
				<div class="items-row cols-<?php echo (int) $this->columns; ?> <?php echo 'row-' . $row; ?> row-fluid col-xs-12 col-sm-6 col-md-4 col-lg-4">
			<?php endif; ?>
