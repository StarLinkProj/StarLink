...
?>
<!-- the div below is generated by template starlink & com_content/category/blog template override -->
<div class="container-fluid block block--spaceUp block--grey blog<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Blog">
  <div class="container">
  ...
  // TODO move this out of blog view
  if ($catid == 9) : ?>
