  ...
  <footer class="footer">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3 col-xs-12 --footer_padding text-right">
          <div class="inline-block" style="height:3rem;width:3rem;margin:0.75rem;">
            <svg version="1.1" class="footer__svg footer__svg_facebook" baseProfile="full" height="100" width="100" fill="#3b5998" viewBox="10 0 190 385" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="inline-block" style="height:3rem;width:3rem;margin:0.75rem;">
            <svg version="1.1" class="footer__svg footer__svg_twitter" baseProfile="full" fill="#00aced" height="95" width="115" viewBox="701 1245 105 79" xmlns="http://www.w3.org/2000/svg">
              <path d="M802,1252.734c-3.679,1.632-7.633,2.734-11.783,3.23c4.235-2.539,7.489-6.559,9.021-11.35	c-3.964,2.351-8.355,4.058-13.029,4.979c-3.742-3.988-9.074-6.479-14.975-6.479c-11.33,0-20.516,9.185-20.516,20.516	c0,1.608,0.181,3.174,0.531,4.675c-17.051-0.855-32.168-9.023-42.287-21.436c-1.766,3.03-2.778,6.554-2.778,10.314	c0,7.118,3.622,13.397,9.127,17.077c-3.363-0.107-6.527-1.03-9.293-2.566c-0.002,0.086-0.002,0.171-0.002,0.258	c0,9.94,7.072,18.232,16.457,20.117c-1.721,0.469-3.534,0.72-5.405,0.72c-1.322,0-2.607-0.129-3.86-0.368	c2.611,8.15,10.188,14.082,19.165,14.247c-7.021,5.503-15.868,8.783-25.48,8.783c-1.656,0-3.289-0.097-4.894-0.287	c9.079,5.821,19.864,9.218,31.449,9.218c37.737,0,58.373-31.262,58.373-58.373c0-0.89-0.021-1.774-0.06-2.654 	C795.771,1260.462,799.25,1256.849,802,1252.734"></path>
            </svg>
          </div>
          <div class="inline-block" style="height:3rem;width:3rem;margin:0.75rem;">
            <svg version="1.1" class="footer__svg footer__svg_googlePlus" baseProfile="full" height="63.5" width="100" fill="#DD4B39" viewBox="-251 470 100 70" xmlns="http://www.w3.org/2000/svg">
              <g>
                <path d="M-215.2,498.1c0,3.6,0,7.2,0,10.8c6.1,0.2,12.1,0.1,18.2,0.2c-2.7,13.4-20.9,17.8-30.6,9		c-9.9-7.7-9.5-24.6,0.9-31.7c7.2-5.8,17.5-4.3,24.7,0.7c2.8-2.6,5.5-5.4,8.1-8.3c-6-4.8-13.4-8.2-21.2-7.8		c-16.4-0.5-31.4,13.8-31.7,30.1c-1,13.4,7.7,26.5,20.2,31.2c12.4,4.8,28.2,1.5,36.1-9.6c5.2-7,6.3-16.1,5.7-24.6		C-195,498.1-205.1,498.1-215.2,498.1z"></path>
                <path d="M-156.1,498.1c0-3,0-6.1-0.1-9.1c-3,0-6,0-9,0c0,3-0.1,6-0.1,9.1c-3,0-6.1,0-9.1,0.1c0,3,0,6,0,9		c3,0,6.1,0.1,9.1,0.1c0,3,0,6,0.1,9.1c3,0,6,0,9,0c0-3,0-6,0.1-9.1c3,0,6.1,0,9.1-0.1c0-3,0-6,0-9		C-150,498.1-153.1,498.1-156.1,498.1z"></path>
              </g>
            </svg>
          </div>
          &nbsp;
