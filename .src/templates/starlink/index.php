 ...
 */
  ...
  <footer class="footer">
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-xs-12 copyright h4 my0">
          &copy; 2016 &nbsp; <a class="footer__link" href="<?php echo JURI::base(); ?>">Старлинк</a>
        </div>
        <div class="col-md-6 col-xs-12 h4 my0">
        ...
        <div class="col-md-3 col-xs-12 h4 my0">
          <div class="footer__socialBlock text-center">
            <a class="footer__link footer__icon inline-block" href="https://www.facebook.com/StarlinkUA/" target="_blank">
              <svg version="1.1"
            ...
            <a class="footer__link footer__icon inline-block" href="https://twitter.com/StarlinkUa/" target="_blank">
              <svg version="1.1"
