...
<div class="container calcItOutsource">
	<h3 class="">Как внедрять новейшие IT-технологии без большого и дорогостоящего IT-отдела?</h3>
	<p class="calcItOutsourceTopParagraph">Решение, которое мы предлагаем &ndash; передать обслуживание всей IT-инфраструктуры команде узкопрофильных специалистов.<br>
